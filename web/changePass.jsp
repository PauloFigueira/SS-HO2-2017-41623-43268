    ...
    <div class="welcome__form"> 
      ...
      action="${pageContext.request.contextPath}/changePass" method="POST">
        ...
        <div class="login__row">
          ...
          <input type="password" class="login__input pass" placeholder="Password" name="password1"/>
        </div>
        <div class="login__row">
          <svg class="login__icon pass svg-icon" viewBox="0 0 20 20">
            <path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0" />
          </svg>
          <input type="password" class="login__input pass" placeholder="Confirm Password" name="password2"/>
        </div>
